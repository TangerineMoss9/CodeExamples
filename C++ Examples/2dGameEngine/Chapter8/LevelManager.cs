...
namespace Chapter8
{
    public static class LevelManager
    {
        ...
        private static float deadTimer = 0;
        ...
        private static void checkCurrentCellCode()
        {
            ...
            //if the code text is "DEAD", kill off the player
            if (code == "DEAD")
            {
                player.Kill();
            }
        ...
        {
            string strLevel = @"Content\Maps\MAP" +
                levelNumber.ToString().PadLeft(3, '0') + ".MAP";

            
            TileMap.LoadMap((System.IO.FileStream)TitleContainer.OpenStream(@strLevel));
        ...
        public static void Update(GameTime gameTime)
        {
            ...
            {
                deadTimer += (float)gameTime.ElapsedGameTime.TotalSeconds;
                if (deadTimer >= 3)
                {
                    ReloadLevel();
                    deadTimer = 0;
